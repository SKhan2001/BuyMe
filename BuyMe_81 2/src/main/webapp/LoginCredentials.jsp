...
<% 	
	try {
		...
		ResultSet rs = stmt.executeQuery("select Username, Password from Accounts where Username = '" + name + "'and Password = '" + pass + "' and isAdmin is false and isCustomerRep is not true");
		...
		if (rs.next()) {
			...
			out.println("\n\tInvalid Username or Password. \nIf logging in as administrative staff, please use the appropriate login tools.");
		}
		stmt.close();
		rs.close();
